  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: <Widget>[
        ...
        Container(height: 58,width: MediaQuery.of(context).size.width/6.55,color: Colors.green,child: Align(alignment:Alignment.center,child: TextButton(child: Text(widget.ButtonTitle,style: TextStyle(color: Colors.white),),onPressed: widget.onpressed(),)),)
      ],),
    );
  }
}
