  ...
  Widget build(BuildContext context) {
    return ResponsiveWrapper.of(context).isTablet || ResponsiveWrapper.of(context).isDesktop ? Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Name: ${widget.Name}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Email: ${widget.Email}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Phone: ${widget.Phone}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Date of birth: ${widget.DateOfBirth}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Address: ${widget.Address}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
          Container(margin:EdgeInsets.only(bottom: 2),child: Text("• Nationality: ${widget.Natinality}",style: TextStyle(color: Colors.black87,fontSize: 17),)),
        ],
      ),
    );
  }
