...
class AchievementVedioList extends StatefulWidget {

  String urlImages ;

  AchievementVedioList(this.urlImages);

  @override
  _AchievementVedioListState createState() => _AchievementVedioListState();
}

class _AchievementVedioListState extends State<AchievementVedioList> {
