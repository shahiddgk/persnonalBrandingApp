...
class BiographyVedioList extends StatefulWidget {

  String urlImages ;

  BiographyVedioList(this.urlImages);

  @override
  _BiographyVedioListState createState() => _BiographyVedioListState();
}

class _BiographyVedioListState extends State<BiographyVedioList> {
